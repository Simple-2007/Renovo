...
{
    snprintf(buffer,size,"DATA;%lu;%04u-%02u-%02u %02u:%02u:%02u;%.2f;%.2f;%.2f;%.2f;%.2f",record.number,
        record.year,record.month,record.day,record.hour,record.minute,
        record.second,record.sensor1,record.sensor2,record.sensor3,record.sensor4,record.sensor5);
}
